...
public class LaifangdengjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,LaifangdengjiEntity laifangdengji,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date laifangshijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date laifangshijianend,
		HttpServletRequest request){
        EntityWrapper<LaifangdengjiEntity> ew = new EntityWrapper<LaifangdengjiEntity>();
                if(laifangshijianstart!=null) ew.ge("laifangshijian", laifangshijianstart);
                if(laifangshijianend!=null) ew.le("laifangshijian", laifangshijianend);
