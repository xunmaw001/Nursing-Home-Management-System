...
public class HulifengxianEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public HulifengxianEntity() {
		
	}
	
	public HulifengxianEntity(T t) {
		try {
	 ...
	 * 设置：护理风险
	 */
	public void setHulifengxian(String hulifengxian) {
		this.hulifengxian = hulifengxian;
	}
	/**
	 * 获取：护理风险
	 */
	public String getHulifengxian() {
		return hulifengxian;
	}
