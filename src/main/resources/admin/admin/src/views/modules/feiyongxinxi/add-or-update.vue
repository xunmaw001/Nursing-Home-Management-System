<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="订单号" prop="dingdanhao">
					<el-input v-model="ruleForm.dingdanhao" placeholder="订单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.dingdanhao" label="订单号" prop="dingdanhao">
					<el-input v-model="ruleForm.dingdanhao" placeholder="订单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="缴费类型" prop="jiaofeileixing">
					<el-input v-model="ruleForm.jiaofeileixing" placeholder="缴费类型" clearable  :readonly="ro.jiaofeileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="缴费类型" prop="jiaofeileixing">
					<el-input v-model="ruleForm.jiaofeileixing" placeholder="缴费类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="费用" prop="feiyong">
