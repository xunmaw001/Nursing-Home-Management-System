	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="医护性别" prop="yihuxingbie">
					<el-input v-model="ruleForm.yihuxingbie" placeholder="医护性别" clearable  :readonly="ro.yihuxingbie"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="医护性别" prop="yihuxingbie">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="离职时间" prop="lizhishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.lizhishijian" 
						type="datetime"
						:readonly="ro.lizhishijian"
						placeholder="离职时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.lizhishijian" label="离职时间" prop="lizhishijian">
					<el-input v-model="ruleForm.lizhishijian" placeholder="离职时间" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	created() {
		this.ruleForm.lizhishijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='lizhishijian'){
							this.ruleForm.lizhishijian = obj[o];
							this.ro.lizhishijian = true;
							continue;
						}
						if(o=='beizhu'){
