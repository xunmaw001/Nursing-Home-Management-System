	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="医护性别" prop="yihuxingbie">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="医护性别" prop="yihuxingbie">
					<el-input v-model="ruleForm.yihuxingbie"
						placeholder="医护性别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="医护等级" prop="yihudengji">
					<el-select :disabled="ro.yihudengji" v-model="ruleForm.yihudengji" placeholder="请选择医护等级" >
						<el-option
							v-for="(item,index) in yihudengjiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="医护等级" prop="yihudengji">
					<el-input v-model="ruleForm.yihudengji"
						placeholder="医护等级" readonly></el-input>
				</el-form-item>
