<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="老人编号" prop="laorenbianhao">
					<el-input v-model="ruleForm.laorenbianhao" placeholder="老人编号" clearable  :readonly="ro.laorenbianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="老人编号" prop="laorenbianhao">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="老人性别" prop="laorenxingbie">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="关系" prop="guanxi">
					<el-input v-model="ruleForm.guanxi" placeholder="关系" clearable  :readonly="ro.guanxi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="关系" prop="guanxi">
